...
from open_r1.utils.ioi import SubtaskResult, add_includes, get_piston_client_from_env, score_subtask
...
def get_reward_funcs(script_args) -> list[Callable]:
    REWARD_FUNCS_REGISTRY = {
        ...
        'code_exec': update_wrapper(
            partial(code_execution_reward, num_parallel=script_args.parallel_code_exec_per_proc), binary_code_reward
        ),
    }
